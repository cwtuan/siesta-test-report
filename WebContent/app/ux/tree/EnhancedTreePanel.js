...
Ext.define('Ecfa.ux.tree.EnhancedTreePanel', {
	...
	/**
	 * create and select folders by path and expand them without loading data from server
	 * 
	 * @param path:
	 *            full ftp path such as "/project1/resource/folder1"
	 * @param autoSelect:
	 *            select the node after creating it. default: true
	 */
	createPath : function(path, autoSelect) {
